...
def build_oa_deepfplearn_gat_model(
    ...
    gat = GraphAttentionLayer(64, dropout_rate=HYPERPARAMS["gat_dropout"], name="gat_layer_1")(
        [atom_input, adjacency_input]
    )
    gat = GraphAttentionLayer(128, dropout_rate=HYPERPARAMS["gat_dropout"], name="gat_layer_2")(
        [gat, adjacency_input]
    )
    gat = GraphAttentionLayer(128, dropout_rate=HYPERPARAMS["gat_dropout"], name="gat_layer_3")(
        [gat, adjacency_input]
    )
